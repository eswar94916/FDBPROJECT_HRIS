<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendMail.aspx.cs" Inherits="Admin_Employee_SendMail" %>
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        <li class="nav-item start active open">
                            <a href="SendMail.aspx" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-body hidden-print" id="empclaim">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" id="lblunit">
                                                        Unit
                                                    </label>
                                                    <div class="col-md-2">
                                                ...
                                                <div class="form-group" align="center">
                                                    ...
                                                    <a href="SendMail.aspx" class="btn blue-chambray">Reset</a>
                                                </div>
                                                <br />
                                                <div class="form-actions">
                                                    <div id="divclaimdetails">
                                                        <table class="table table-striped table-bordered table-hover order-column" id="tblclaim" style="border-radius: 8px;table-layout:fixed; border: 4px black" border="1">
                                                    ...
                                                    <div class="col-md-offset-5" id="divbirmail">
                                                        <button type="button" class="btn blue-steel" style="color: white" id="btnsend" align="center">Send Mail</button>
                                                        <button type="button" class="btn bg-yellow" style="color: white" id="btnback" align="center">Back</button>
                                                    </div>
                                                    <div class="col-md-offset-5" id="divannimail">
                                                        <button type="button" class="btn blue-steel" style="color: white" id="btnsend1" align="center">Send Mail</button>
                                                        <button type="button" class="btn bg-yellow" style="color: white" id="btnback1" align="center">Back</button>
                                                    </div>
                                                    <div class="col-md-offset-5" id="divjobmail">
                                                        <button type="button" class="btn blue-steel" style="color: white" id="btnsend2" align="center">Send Mail</button>
                                                        <button type="button" class="btn bg-yellow" style="color: white" id="btnback2" align="center">Back</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
