<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppraisalHistory.aspx.cs" Inherits="Admin_Employee_AppraisalHistory" %>
...
<head>
    <meta charset="utf-8" />
    <title>HRIS-Appraisal History</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="onbodyload()">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        ...
                        <li class="nav-item active open" id="liSalarySlip">
                            <a href="AppraisalHistory.aspx" class="nav-link nav-toggle">
                                <i class="icon-book-open"></i>
                                <span class="title">Appraisal History</span>
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title hidden-print">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Appraisal History</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-body hidden-print" id="divmain">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label col-md-1">From Year</label>
                                                    <div class="col-md-1" style="width: 150px;">

                                                        <select class="form-control select2me" id="ddlyear" style="width: 300px;">
                                                ...
                                                <div class="form-group" align="center">
                                                    ...
                                                    <a href="AppraisalHistory.aspx" class="btn purple button">Reset</a>
                                                </div>
    ...
    <script src="../../script/Appraisalhistory.js"></script>
