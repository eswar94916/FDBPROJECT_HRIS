<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentStatusReport.aspx.cs" Inherits="Admin_Employee_DocumentStatusReport" %>
...
<head>
    <meta charset="utf-8" />
    <title>HRIS-Doc Status Report</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="onbodyload()">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        ...
                        <li class="nav-item active open" id="liSalarySlip">
                            <a href="DocumentStatusReport.aspx" class="nav-link nav-toggle">
                                <i class="icon-book-open"></i>
                                <span class="title">Document Status Report</span>
                            ...
                            <div class="portlet light " id="empjoinreport">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Document Status Report</span>
                                    </div>
                                    <div class="tools"></div>
                                </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2" align="center">
                                                    ...
                                                    <a href="DocumentStatusReport.aspx" class="btn purple button">Reset</a>
                                                </div>
                                            </div>
                                            <br />
                                        </div>
    ...
    <script src="../../script/empdocdet.js"></script>
