...
function showDetails() {
    ...
    $.ajax({
        ...
        url: "FullAndFinalReportServices.aspx/empfullnfinalreport",
        dataType: "json",
        async: true,
        success: function (data, status) {
            var varList = (data.d);
            ...
            if (varList.length == 0) {
                ...
                $(varList).each(function (index, o) {
                    ...
                    t.row.add(['<label>' + serial_no + '</label>', '<label>' + o.UnitName + '</label>', '<label>' + o.EmployeeCode + '</label>', '<label>' + o.EmpName + '</label>', '<label>' + o.DepartmentName + '</label>', '<label>' + o.DesignationName + '</label>', '<label>' + o.Month + '</label>', '<label>' + o.SalYear + '</label>', '<label>' + o.JoiningDate + '</label>', '<label>' + parseFloat(o.Gross).toFixed() + '</label>', '<label>' + parseFloat(o.CTC).toFixed() + '</label>', '<label>' + o.DOR + '</label>', '<label>' + o.DOFF + '</label>', '<label>' + parseFloat(o.NetPay).toFixed() + '</label>', '<label>' + o.FNFChequeNo + '</label>']).draw();
                });
            }
            $('#sample_2').show();
            $('#divdetails').show();
