<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportEmpIncrementDetails.aspx.cs" Inherits="Admin_Employee_ImportEmpIncrementDetails" EnableEventValidation="false" %>
...
<head>
    <meta charset="utf-8" />
    <title>HRIS-Import Increment Details</title>
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        ...
                        <li class="nav-item active open" id="liSalarySlip">
                            <a href="ImportEmpIncrementDetails.aspx" class="nav-link nav-toggle">
                                <i class="icon-book-open"></i>
                                <span class="title">Import Employee Increment Details</span>
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Import Employee Increment Details</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-body hidden-print" id="divSlip">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <a href="../../DemoFile/EmpIncrementFile.xlsx" download="download">Download Demo File</a>
                                                    </div>
                                                </div>
