<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadIdproof.aspx.cs" Inherits="Admin_Employee_UploadIdproof" %>

<!DOCTYPE html>

<html lang="en">
<head>
    <title>HRIS-Upload Aadhaar Card</title>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-3">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-tabs-sm">
                                    ...
                                    <li id="tab17" class="active btn btn-circle" style="background-color: #337AB7">
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject bold uppercase">Upload Aadhaar Card
                                            </span>
                                        </div>
                                    </div>
