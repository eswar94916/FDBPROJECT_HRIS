<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyPFLedger.aspx.cs" Inherits="Admin_Employee_MonthlyPFLedger" %>
...
<head>
    <meta charset="utf-8" />
    <title>HRIS-PF/ESI Report</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="onbodyload()">
    <!-- BEGIN HEADER --> <div id="dvLoading"></div>
    <form runat="server">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        ...
                        <li class="nav-item active open" id="liSalarySlip">
                            <a href="MonthlyPFLedger.aspx" class="nav-link nav-toggle">
                                <i class="icon-book-open"></i>
                                <span class="title">PF & ESI Report</span>
                            ...
                            <div class="portlet light hidden-print" id="empjoinreport">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">PF & ESI Report</span>
                                    </div>
                                    <div class="tools"></div>
                                </div>
                                    ...
                                    <div class="form-horizontal" id="divfilter">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <label class="control-label" id="lblsal">
                                                        Select Filter
                                                    </label>
                                                    <select class="form-control select2me" id="ddlsaltype">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select class="form-control select2me" id="ddlmonth" multiple>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <a href="MonthlyPFLedger.aspx" class="btn purple button">Reset</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="divdetails">
                                    <div class="form-body">
                                        <div class="tools"></div>
                                        <table class="table table-striped table-bordered table-hover order-column table-responsive" id="sample_1" style="border-radius: 8px; border: 4px black" border="1">
                                ...
                                <div id="divdetails1">
                                    <div class="form-body">
                                        <br />
                                        <div class="tools"></div>
                                        <table class="table table-striped table-bordered table-hover order-column table-responsive" id="sample_2">
                                            <thead style="background-color: #116494; color: white; border-radius: 8px; border: 1px solid black">
                                                <tr style="border-radius: 3px; border: 2px solid black">
                                                    <th>S.No</th>
                                                    <th>Unit</th>
    ...
    <script src="../../script/monthlypfledgr.js"></script>
