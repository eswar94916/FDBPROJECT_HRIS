<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpDeduction.aspx.cs" Inherits="Admin_Employee_EmpDeduction" %>
...
<head>
    <meta charset="utf-8" />
    <title>HRIS-Employee Deductions</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="bodyonload()">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            ...
                            <ul class="nav nav-pills nav-stacked nav-tabs-sm">
                                ...
                                <li id="tab19" class="active btn btn-circle" style="background-color: #337AB7">
    ...
    <script src="../../script/empdeduction.js"></script>
