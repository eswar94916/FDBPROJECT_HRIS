<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeTransferDetails.aspx.cs" Inherits="Admin_Employee_EmployeeTransferDetails" %>
...
<head>
    <meta charset="utf-8" />
    <title>HRIS-Employee Transfer</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="bodyonload()">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        <li class="nav-item start active open">
                            <a href="EmployeeTransferDetails.aspx" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                                <span class="title">Manage Employee Transfer </span>
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject bold uppercase">Manage Employee Transfer </span>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-body hidden-print" id="empclaim">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="username" readonly="readonly" id="Txttranferfromunit" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control select2me" id="ddltranfertounit">
                                                            <option value="0">Select</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input class="form-control date-picker" type="text" id="txtlastworkdate" data-date-format="dd-M-yyyy" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input class="form-control  date-picker" type="text" id="txtreportdate" data-date-format="dd-M-yyyy" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div align="center">
                                                        ...
                                                        <button type="button" class="btn bg-yellow" style="width: 120px; color: white" id="btnreset">Reset</button>
                                            ...
                                            <div class="form-actions">
                                                <div id="divtransfer">
                                                    ...
                                                    <br />
                                                    <div class="tools"></div>
                                                    <table class="table table-striped table-bordered table-hover order-column" id="sample_1" style="border-radius: 8px;">
                                                        <thead style="background-color: #116494; color: white;">
                                                            <tr>
                                                                ...
                                                                <th style="width: 100px;">Transferred From</th>
                                                                <th style="width: 100px;">Transferred To</th>
                                                                <th style="width: 100px;">Last Working Date</th>
                                                                <th style="width: 100px;">Reporting Date</th>
    ...
    <script src="../../script/EmpTransferDet.js"></script>
