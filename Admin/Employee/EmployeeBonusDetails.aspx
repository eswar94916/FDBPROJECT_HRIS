<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeBonusDetails.aspx.cs" Inherits="Admin_Employee_EmployeeBonusDetails" %>
...
<head>
    <meta charset="utf-8" />
    <title>HRIS-Employee Bonus Report</title>
    ...
    <%: System.Web.Optimization.Styles.Render("~/bundles/CSSDate") %><link href="../../assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="onbodyload()">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        ...
                        <li class="nav-item active open" id="liSalarySlip">
                            <a href="EmployeeBonusDetails.aspx" class="nav-link nav-toggle">
                                <i class="icon-book-open"></i>
                                <span class="title">Employee Bonus Report</span>
                            ...
                            <div class="portlet light " id="empjoinreport">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Employees Bonus Report</span>
                                    </div>
                                    <div class="tools"></div>
                                </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2" align="center">
                                                    ...
                                                    <a href="EmployeeBonusDetails.aspx" class="btn purple button">Reset</a>
                                                </div>
                                            </div>
                                            <br />
                                        </div>
                                ...
                                <div id="divdetails">
                                    <div class="form-body">
                                        <div class="tools"></div>
                                        <table class="table table-striped table-bordered table-hover order-column table-responsive" id="sample_2" style="border-radius: 8px; border: 4px black">
    ...
    <script src="../../script/empbonus.js"></script>
