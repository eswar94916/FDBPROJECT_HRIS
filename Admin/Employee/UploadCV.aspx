<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadCV.aspx.cs" Inherits="UploadCV" %>

<html lang="en">
<head>
    <title>HRIS-Upload Resume</title>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <ul class="nav nav-pills nav-stacked nav-tabs-sm">
                                    ...
                                    <li id="tab13" class="active btn btn-circle" style="background-color: #337AB7">
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject bold uppercase">Upload Resume
                                            </span>
                                        </div>
                                    </div>
