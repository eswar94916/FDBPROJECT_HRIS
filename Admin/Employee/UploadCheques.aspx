<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadCheques.aspx.cs" Inherits="Admin_Employee_UploadCheques" %>
                    ...
                    <div class="row" id="divuploadques">
                        <div class="col-md-12">
                            <div class="col-md-3">
                                ...
                                <ul class="nav nav-pills nav-stacked nav-tabs-sm">
                                    <li id="tab16" class="active btn btn-circle" style="background-color: #337AB7">
