<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeTraining.aspx.cs" Inherits="EmployeeDetails_AssignTraining" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="onbodyload()">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                    <li class="nav-item start active open">
                        <a href="EmployeeTraining.aspx" class="nav-link nav-toggle">
                            <i class="icon-home"></i>
                            <span class="title">Manage Employee Training</span>
                        ...
                        <div class="portlet light portlet-fit ">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject bold uppercase">Assign Training To Employee</span>
                                </div>
                            </div>
                                    ...
                                    <div class="form-body hidden-print" id="empclaim">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select2me" id="ddltrainame">
                                                        <option value="0">Select</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="username" id="txttraininstitute" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="username" id="txttrainlocation" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control date-picker" type="text" id="txtstartdate" data-date-format="dd-M-yyyy" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control  date-picker" type="text" id="txtenddate" data-date-format="dd-M-yyyy" />
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover order-column" id="tbldetail" style="border-radius: 8px;" border="1">
                                                    <thead style="background-color: #116494; color: white; border-radius: 8px; border: 1px solid black">
                                                        <tr style="border-radius: 3px; border: 2px solid black">
                                                            ...
                                                            <th style="width: 100px;">Training Name</th>
    ...
    <script src="../../script/EmployeeTraining.js"></script>
