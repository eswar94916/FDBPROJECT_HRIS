<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employeepromotion.aspx.cs" Inherits="EmployeeDetails_employeehistory" %>

<!DOCTYPE html>

<html>
<head>
    <title>HRIS-Increment Report</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md" onload="onbodyload()">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
                        ...
                        <li class="nav-item active open" id="liSalarySlip">
                            <a href="employeepromotion.aspx" class="nav-link nav-toggle">
                                <i class="icon-book-open"></i>
                                <span class="title">Increment Report</span>
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject bold uppercase">Increment Report</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-body hidden-print" id="divSlip">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="reset" class="btn purple" id="btnreset" value="Reset" />
                                                </div>
                                            </div>
                                        </div>
                                        <br />
    ...
    <script src="../../Script/emppromotionreport.js"></script>
